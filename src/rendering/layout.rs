...
/// Screen dimensions.
pub(super) const SCREEN_W: i32 = 480;
pub(super) const SCREEN_H: i32 = 320;

/// Horizontal padding from the screen edges.
pub(super) const H_PAD: i32 = 8;

/// ---- Translation region (top ~2/3 of screen) ----
pub(super) const TRANSLATION_Y: i32 = 4;
pub(super) const TRANSLATION_PX: f32 = 48.0;
pub(super) const TRANSLATION_COLOR: Rgb666 = Rgb666::new(32, 58, 63); // light cyan

/// Y coordinate of the separator line between regions.
pub(super) const SEPARATOR_Y: i32 = 264;

/// ---- Transcript region (bottom strip) ----
pub(super) const TRANSCRIPT_Y: i32 = SEPARATOR_Y + 3;
pub(super) const TRANSCRIPT_PX: f32 = 20.0;
pub(super) const TRANSCRIPT_COLOR: Rgb666 = Rgb666::new(48, 48, 48); // light grey
...
pub(super) fn draw_separator(fb: &mut Framebuffer) {
